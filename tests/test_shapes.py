    ...
    assert _conforms(_mutate(f"""
        INSERT {{ GRAPH <{WORLD_GRAPH}> {{
            ag:chatter_fern a sosa:Sensor , ag:Device ; ag:localId "chatter_fern" ; mqtt:onBus ag:local_bus ;
                perception:senseMode perception:PushReporting ; perception:monitors ag:fern ; sosa:observes water:SoilMoisture ;
    ...
    return _mutate(f"""
        INSERT {{ GRAPH <{WORLD_GRAPH}> {{
            ag:second_probe_fern a sosa:Sensor , ag:Device ; ag:localId "second_probe_fern" ;
                mqtt:onBus ag:local_bus ; perception:senseMode perception:ScheduledSampling ; perception:monitors ag:fern ;
