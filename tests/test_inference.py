...
from orexis_modality_graph.ontology import AG, ONTOLOGY_ENTAILED_GRAPH, ONTOLOGY_GRAPH, WORLD_ENTAILED_GRAPH, WORLD_GRAPH
...
SELECT ?hosted WHERE { <http://example.org/orexis/world/sensing#esp32_fern>
  <http://www.w3.org/ns/sosa/hosts> ?hosted }"""))
    ...
    from orexis_modality_graph.ontology import WORLD_ENTAILED_GRAPH
