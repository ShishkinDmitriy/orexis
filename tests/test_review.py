...
from modality.ontology import STATE_GRAPH, WORLD_GRAPH, beliefs_graph, term
...
def test_a_world_that_widens_a_mandate_will_not_validate():
    ...
    """
    from modality.ontology import PROVENANCE_GRAPH
...
def _sensing_with(update: str = ""):
    ...
    from modality.ontology import WORLD_DERIVED_GRAPH
