...
The physical decomposition was never missing — `packages/orexis-part-microcontroller/` has had
...
restated in `packages/orexis-capability-sensing/ontology.ttl`, since we borrow IRIs and never import
