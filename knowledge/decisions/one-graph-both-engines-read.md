...
- **twenty-five** subclass axioms were declared across `vocabulary/` and `packages/orexis-capability-*/`
...
The trap had already caught the code twice. `orexis:models rdfs:subPropertyOf sensing:polls` made shapes
