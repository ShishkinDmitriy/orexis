...
- ~~**The bus.**~~ Closed by [the-link-is-the-transports](/decisions/the-link-is-the-transports.md). `MessageBus` and `load_bus` were still the kernel's, and `mqtt:` was the one
