...
| was | is | granted by |
|---|---|---|
| `desire:Deducing` | `agent/deducer.py` (the aim; the region and its arithmetic went on to sensing — [the-stake-is-sensings-want](/decisions/the-stake-is-sensings-want.md)) | nothing |
