...
- **The BRF is implicit**, as the first record already says: what is worth waking the
  deliberator for is decided by who calls `pursue_for`, not by one named function.
