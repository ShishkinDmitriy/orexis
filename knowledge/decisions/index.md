...
* [the-search-reads-predictions-and-computes-none](/decisions/the-search-reads-predictions-and-computes-none.md) - A prediction is a graph holding during a period, written by its package; the search reads it at a node's instant and runs no drift.
