...
* [the-substrate-is-not-the-minds](/decisions/the-substrate-is-not-the-minds.md) - SOSA's classes may be virtual, so the substrate word survives — but the kernel does not own it; `packages/part/device/` does.
