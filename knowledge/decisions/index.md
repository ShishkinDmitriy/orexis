...
* [one-expectation-and-the-reading-is-held-to-it](/decisions/one-expectation-and-the-reading-is-held-to-it.md) - One expected next observation per subject and property, from the branch the agent is on; one comparison at arrival is every verdict.
