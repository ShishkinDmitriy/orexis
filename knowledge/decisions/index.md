...
* [an-outcome-is-an-expected-cost-not-a-branch](/decisions/an-outcome-is-an-expected-cost-not-a-branch.md) - Odds enter the search as cost over likelihood, a step relies on one outcome; contingent plans and a chance on the pump refused.
