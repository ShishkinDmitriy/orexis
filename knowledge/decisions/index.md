...
* [a-drift-says-bands-and-the-core-computes-no-number](/decisions/a-drift-says-bands-and-the-core-computes-no-number.md) - The drift stays and types its prediction with every band it may be in; no width, centre or exact value crosses into the core.
