...
**`ag:lanAddress` is `orexis:lanHost`, and a world states a name.**

```turtle
orexis:raspberry a orexis:ComputeHost ; orexis:lanHost "raspberry.local" .
```
