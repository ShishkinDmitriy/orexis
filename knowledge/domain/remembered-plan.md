...
description: >-
  ...
  served, its steps carrying their predictions and preconditions. Keyed by its regressed
...
applies here: the plan's **regressed precondition** — step n's precondition less what steps 1 to
...
not remembered twice. One lifted before its steps carried a precondition is forgotten when asked,
