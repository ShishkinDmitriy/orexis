...
carries the pick and the series, the instance node the walk and the override audit, the root
...
- [desire](/domain/desire.md) — the kind of thing every node of a tree is.
- [region](/domain/region.md) — what a per-property want holds its instance inside.
- [urgency](/domain/urgency.md) — what rolls up a tree, the hottest child at every hop.
