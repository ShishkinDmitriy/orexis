...
* [cell](/domain/cell.md) - The gap between two thresholds some rule compares a property against: a reading's identity when matched. Refused as the core's; a class the domain declares.
