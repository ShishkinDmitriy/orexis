...
| `ag:Actuate` | move it myself — lever and resource both mine (#190) | the reflex picks the cheaper rung over Acquire | the self-dose is commanded (co-signed, confirmed like any dose); the expectation carries the end |
