...
adopts the other kind — a [triggered action](/domain/triggered-action.md), the market's
Presenting — with no search above it, and both stand in the same ledger and wait on the same
kind of expectation.
