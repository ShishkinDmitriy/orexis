...
- where its action may turn out more than one way, which [outcome](/domain/outcome.md) it was
  planned through (`orexis:reliesOn`) — the one its prediction is the diff of
