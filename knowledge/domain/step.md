...
- it carries what it PREDICTED (`progression:predicts`): the facts the search said taking it makes
  true and false, in the plan's own canonical form — a reading as the [interval](/domain/interval.md)
  its rule declared (#556) — which is what the world is held to once it is taken, and why no
  actor sizes an expectation of its own or states how close
