...
- an [intention](/domain/intention.md) commits to an act — the action, lever and want the
  ledger records today are its parts, and `ag:by` will name the act node itself;
