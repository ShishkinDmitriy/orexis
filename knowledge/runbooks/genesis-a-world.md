...
|---|---|
| `perception:polls` a sensor with `perception:senseMode perception:ScheduledSensing` | `perception:Subscribing` |
| `perception:polls` a sensor with `perception:senseMode perception:PushSensing` | `perception:Listening` |
