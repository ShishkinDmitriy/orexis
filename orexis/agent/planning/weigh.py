...
from orexis.agent.ontology import DESIRE, OREXIS, RECORD, WANT, local_of
from orexis.agent.store import NAMESPACES, Raw, bind, catalogue_of, graphs_of, rdflib_view, remember, rows, update
