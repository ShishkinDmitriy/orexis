...
from orexis.agent.hash_named_graph import digest_of
from orexis.agent.ontology import PUBLIC, local_of
from orexis.agent.store import (Raw, bind, bindings, catalogue_of, closed, construct, fork,
