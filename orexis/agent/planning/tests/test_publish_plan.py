...
commitment, and that a planner told nothing about a ledger writes to none.
"""
...
from orexis.agent.store import close_catalogue, put_graph, query_over, bindings
...
def _ledger(intentions, what: str) -> list[dict]:
...
def test_an_answer_is_not_a_commitment(beliefs):
    ...
    stands in the ledger for a want nobody is doing anything about — an empty plan is an
