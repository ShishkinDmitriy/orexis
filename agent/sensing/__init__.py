...
property, typed with the bands the domain declares, standing as the present until the
...
graphs of band sets holding during their windows, each starting where the classification
...
a band and a crossing is the derivation's, and what to do about not knowing is the desire's
own sentence (#783).

**IT IS THE LAYER THAT WORKS WITH THE NUMBERS**, and the one that decides what is state. The
mind's world is bands: the graph a reading is read from holds its key and its bands, and its
