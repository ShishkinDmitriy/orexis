...
moment"* are different claims. Under `ScheduledSampling` a reading that does not arrive means the
board is late; under `PushReporting` it may mean nothing happened worth reporting. Until now that
