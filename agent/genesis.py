...
from orexis_modality_graph.ontology import (DESIRE_ASSERTED_GRAPH, ACTIONS_GRAPH, GRAPH_PREFIX, ONTOLOGY_ENTAILED_GRAPH, ONTOLOGY_GRAPH,
                       WORLD_DERIVED_GRAPH,
                       WORLD_ENTAILED_GRAPH, WORLD_GRAPH, beliefs_graph)
from orexis_modality_graph.store import NAMESPACES, Store, bindings
...
def drop_ghost_graphs(st: Store, agent_id: str) -> list[str]:
    ...
    """
    from orexis_modality_graph.ontology import AG, PROVENANCE_GRAPH
...
def classify_own_graphs(st: Store, agent_id: str) -> None:
    ...
    """
    from orexis_modality_graph.ontology import AG, CLASSIFICATION_GRAPH, obligations_graph
