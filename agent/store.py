...
# instances are declared in `packages/core/orexis/ontology.ttl`, and adding one is a vocabulary edit
...
# learning it exists. `ag:` arrives that way too, from `packages/core/orexis/ontology.ttl`: the base
