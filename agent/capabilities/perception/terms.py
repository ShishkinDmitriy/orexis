...
PULL = term("PolledSensing")           # answers when asked — the unbuilt perception:Polling would serve it
SCHEDULED = term("ScheduledSensing")   # keeps an interval it is given -> perception:Subscribing
PUSH = term("PushSensing")            # keeps its own clock, takes no orders -> perception:Listening
