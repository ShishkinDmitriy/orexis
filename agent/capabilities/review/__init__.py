...
One of the two ways of reviewing. `ag:Consulting` — asking a model instead of working it out — is
declared in `ontology.ttl` and deliberately absent here, exactly as `ag:Polling` is for
