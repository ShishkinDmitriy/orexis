...
from orexis_progression_patience.ontology import (BELIEF_REVISED, DESIRES, DESIRE_URGENCY, QUIET, REPORTS,
...
#  `Timer` WAS HERE, and is progression's now (`orexis_progression_patience.timer`, #452):
