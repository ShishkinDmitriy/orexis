...
defined by the packages that own those parts:
    ...
    packages/part/dht11/wokwi/     the KY-015 breakout
    packages/part/rgb_led/wokwi/   the KY-016 module
...
pins and its datasheet figures. Deleting `packages/part/rgb_led/` takes its board with it.
