...
through `orexis_modality_graph.ontology` because they are the kernel's, not this package's to move. See
...
def term(name: str) -> str:
    """One of this package's own terms. The kernel's are reached through `orexis_modality_graph.ontology`."""
    return NS + name
