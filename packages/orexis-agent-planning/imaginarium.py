...
from orexis_agent_execution.ontology import GRAPH_PREFIX, OREXIS, PUBLIC, STATE_GRAPH, local_of
...
class Imaginarium:
    ...
    def __init__(self, beliefs: ox.Store, *private: str):
        ...
        self.memo = Memo()
        init_imaginarium(beliefs, self.engine, *private)
