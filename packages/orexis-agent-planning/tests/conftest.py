"""The planning package's own test options, and the snapshot machinery its case tests share
(`test_derive_wants.py`, `test_scope_actions.py`, `test_init_imaginarium.py`).
...
from orexis_agent_execution.ontology import OREXIS, picks_graph
from orexis_agent_execution.store import (catalogue_of, close_catalogue, dump_nt,
