...
Here rather than in the kernel vocabulary (`packages/orexis-agent-progression/ontology.py`) for the reason that file states about itself: everything
...
def summaries_graph(agent_id: str) -> str:
    ...
    """
    return GRAPH_PREFIX + "summaries/" + agent_id
